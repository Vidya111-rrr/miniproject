...
const Home = () => {
  return (
    <div className="text-center p-12 bg-gray-100">
     ...
     { /*-- Live Stats Section */}
    <section class="bg-white p-12 rounded-lg shadow-lg mb-8 text-center">
        <h2 class="text-3xl font-semibold mb-6">EcoSync Impact</h2>
        <div class="flex flex-wrap justify-around">
            <div class="w-full md:w-1/3 p-4">
                <h3 class="text-2xl font-bold text-teal-700">59,76,236+</h3>
                <p>Total Waste Collected</p>
            </div>
            <div class="w-full md:w-1/3 p-4">
                <h3 class="text-2xl font-bold text-teal-700">34,56,890+</h3>
                <p>Happy Users</p>
            </div>
            <div class="w-full md:w-1/3 p-4">
                <h3 class="text-2xl font-bold text-teal-700">99,342+ Cities</h3>
                <p>Areas Covered</p>
            </div>
        </div>
    </section>
